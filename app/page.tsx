...
export default function Home() {
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-[#0A0B0F]">
      ...
      {/* Content Overlay */}
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 py-8 sm:py-12 md:py-16 lg:py-20">
          ...
          <div className="glass-card max-w-3xl mx-auto px-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 text-center">
              <div className="space-y-3 sm:space-y-4">
                ...
                <div className="font-sora text-white/70 text-xs sm:text-sm">Sender sponsors receiver&apos;s gas fees</div>
              </div>
              <div className="space-y-3 sm:space-y-4">
                <div className="w-12 h-12 sm:w-16 sm:h-16 mx-auto rounded-2xl flex items-center justify-center transition-all duration-300 hover:scale-110 bg-white/10 border border-white/20 backdrop-blur-sm">
                ...
                <div className="font-sora text-white/70 text-xs sm:text-sm">Recipients get funds immediately</div>
              </div>
